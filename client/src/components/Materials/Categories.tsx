  ...
  const [categories, setCategories] = useState<Category[]>([
    {
      id: '1',
      name: 'Witaminy',
      usedInProducts: ['Witamina C 1000mg', 'Witamina D3 4000IU', 'Multi Complex', 'B-Complex'],
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Kategorie składników</h1>
            <p className="text-gray-600">Zarządzaj listą kategorii składników</p>
          </div>
          <button
